...
ACTIVE_PRODUCTS = [
    ProductMetadata(stripe_id='prod_I1ZYWQ8BnNqvtS', name='Stockk Premium', features=['Stockk Premium Feature 1', 'Stockk Premium Feature 2', 'Stockk Premium Feature 3'], description='The Stockk Premium plan', is_default=True),
]
